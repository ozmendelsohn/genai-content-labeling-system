 ...
 * 
 * A modern, responsive login form with error handling, loading states,
 * and proper validation for the GenAI Content Labeling System.
 */
...
import { login as loginUser, LoginRequest } from '@/lib/auth';
